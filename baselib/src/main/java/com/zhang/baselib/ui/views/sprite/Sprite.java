package com.zhang.baselib.ui.views.sprite;
...
import com.zhang.baselib.ui.views.FloatProperty;
import com.zhang.baselib.ui.views.IntProperty;
import com.zhang.baselib.utils.AnimationUtil;
...
public abstract class Sprite extends Drawable implements
    ...
    @Override
    public void start() {
        if (AnimationUtil.isStarted(animator)) {
            return;
        }
    ...
    public boolean isRunning() {
        return AnimationUtil.isRunning(animator);
    }
