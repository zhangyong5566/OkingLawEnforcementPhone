...
import com.zhang.okinglawenforcementphone.mvp.ui.activitys.ImageGridActivity;
import com.zhang.okinglawenforcementphone.mvp.ui.activitys.VideoCallActivity;
import com.zhang.okinglawenforcementphone.mvp.ui.activitys.VoiceCallActivity;
...
public class ChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        toChatUsernameTitle = fragmentArgs.getString(EaseConstant.EXTRA_USER_ID);
    ...
    protected void setUpView() {
        titleBar.setTitle(toChatUsernameTitle);
        //隐藏最左边返回
    ...
    protected void registerExtendMenuItem() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            inputMenu.registerExtendMenuItem(R.string.attach_sos_call, R.drawable.em_sos_call_selector, ITEM_SOS_CALL, extendMenuItemClickListener);
        }
    }
    ...
    class GroupListener extends EaseGroupRemoveListener {
        ...
        public void onGroupDestroyed(final String groupId, String groupName) {
            ...
            getActivity().runOnUiThread(new Runnable() {
                public void run() {
                    if (toChatUsername.equals(groupId)) {
                        Toast.makeText(getActivity(), "当前群聊已被群创建者解散", Toast.LENGTH_LONG).show();
                        Activity activity = getActivity();
                        if (activity != null && !activity.isFinishing()) {
                            activity.finish();
                        }
