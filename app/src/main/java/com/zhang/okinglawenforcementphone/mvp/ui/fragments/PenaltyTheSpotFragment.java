 ...
 * 当场处罚决定书
 */
public class PenaltyTheSpotFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mInflate == null) {
            mInflate = inflater.inflate(R.layout.fragment_penalty_the_spot, container, false);
    ...
    public void initView() {
        ...
        mExpandablePenaltyTheSpotAdapter = new ExpandablePenaltyTheSpotAdapter(getActivity(), generateData());
