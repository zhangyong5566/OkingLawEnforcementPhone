 ...
 * 案件受理
 */
public class OpenCasesFragment extends Fragment {
    ...
    public static OpenCasesFragment newInstance(String param1, String param2) {
        OpenCasesFragment fragment = new OpenCasesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mInflate == null) {
            ...
            mInflate = inflater.inflate(R.layout.fragment_open_cases, container, false);
        }
