...
public class FromAllLawEnforcementActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_from_all_law_enforcement);
                ...
                switch (view.getId()) {
                    case R.id.bt_idcard:
                        if (!checkTokenStatus()) {
                            ...
                            Intent intent = new Intent(FromAllLawEnforcementActivity.this, CameraActivity.class);
    ...
    private void initView() {
        ...
        mExpandableStopIllegalAdapter = new ExpandableStopIllegalAdapter(FromAllLawEnforcementActivity.this, generateData());
