...
public class JPushHttpFactory {
    private static JPushHttpFactory baseHttpFactory;

    private JPushHttpFactory() {
    }

    public static JPushHttpFactory getInstence() {
        if (baseHttpFactory == null) {
            synchronized (JPushHttpFactory.class) {
                if (baseHttpFactory == null) {
                    baseHttpFactory = new JPushHttpFactory();
                }
            }
        }
